...
DROP POLICY IF EXISTS "Users can read responses for their tickets" ON public.ticket_responses;
...
DROP POLICY IF EXISTS "Admins can CRUD all responses" ON public.ticket_responses;
